...
const CustomsCentered = () => {
  ...
  let blogs = [
    {
      image: "/images/BlogBanner/BlogTwoRecent.png",
      title:
    ...
    {
      image: "/images/BlogBanner/BlogThreeRecent.png",
      title:
        "The digital transformation of customs clearance and how technology is transforming the process",
      description:
    ...
    {
      image: "/images/Services/Customs_Clearence/recent-three.png",
      title:
        "The impact of UAE-Oman transportation on trade and commerce to driving economic growth",
      description:
        " In today’s global economy, businesses are always looking for  ways to expand their reach and increase profits. One of the key factors in achieving this is efficient transportation and logistics. The United Arab Emirates and Oman have experienced significant growth and development in their transportation sector, leading to increased connectivity between the two countries. This has opened up new opportunities for businesses looking to expand their operations and tap into new markets for logistics companies in Oman. However, navigating the complexworld of transportation and logistics can be challenging, particularly for businesses with limited experience in this area. This is where the importance of a reliable logistics partner comes in. In this article, we will explore the impact oftransportation on business growth in the UAE and Oman, and the crucial role that logistics partners play in helping businesses achieve their goals.",
    },
  ];
  ...
  return (
    <div className="container-custom mx-auto">
      <div className="row">
        <div className="col-md-6 recent-top-pad">
          <div className="row">
        ...
        >
          <div className="row" style={{ padding: "30px" }}>
            ...
            {blogs.map(({ image, title, description }) => (
              <div className="mt-3">
                <img src={image} className="w-100" alt="Recent Post " />
      ...
      <div className="row">
        <div className="mt-5">
          ...
          <p className="centered-clr-text">
            Navigating customs clearance in Oman isn’t without its challenges.
          ...
          <i className="bi-blog-compliance" style={{ fontStyle: "normal" }}>
            •
            <p className="blog-compliance-p">
              Stay informed about Oman’s customs regulations and consult with
              experts when needed.
            </p>
          </i>
          ...
          <i className="bi-blog-compliance" style={{ fontStyle: "normal" }}>
            •
            <p className="blog-compliance-p">
              Pay customs duties and taxes promptly to prevent storage charges
              and delays.
            </p>
          </i>
          ...
          <div className="row">
            <div className="col-md-6">
              <button
                ...
                className="centered-get-quotes-font w-50 mt-3"
              >
                Get A Quote
              </button>
            </div>
