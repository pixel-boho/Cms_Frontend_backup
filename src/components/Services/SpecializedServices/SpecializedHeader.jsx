...
import "./../../../css/ServicesCss/SpecializedHeader.scss";
...
const SpecializedHeader = () => {
  ...
  return (
    <>
      <div className="container-fluid nav-bg quote-img">
        <div className="col-lg-12">
          <div className="row">
            <div className="col-lg-12 quote">
              <h1 className="text text-center">Specialized Services</h1>

              <p className="text1 text-center"></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid">
        <div className="col-lg-12 pt-4">
          <div className="row text-nav-pad">
