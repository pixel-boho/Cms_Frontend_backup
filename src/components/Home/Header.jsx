...
const Header = () => {
  ...
  return (
    <div
      className={[styles["container-fluid"], styles["imag-first-header"]].join(
        " "
      )}
    >
      <div className={styles.header}>
        <div className={styles["text-fields"]}>
          ...
          <p className={styles["font-paragraph-one"]}>
            ALSI: Your dedicated partner for comprehensive logistics services
            and solutions. With expertise in customs clearance, transportation,
            freight forwarding, project cargo services and warehousing, we
            optimize your supply chain. Partner with ALSI and experience
            hassle-free logistics that help achieve your business goals.
          </p>
          <a href="/about_us">
            Read More
            <img
